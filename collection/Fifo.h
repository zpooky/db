        ...
        T pop(D &&def) {
            ...
            do {
                redo: if (current == nullptr) {
                     ...
                     *  this is a edge case when a concurrent push is accuring into an empty Fifo.
                     *  initially the push head is set then the poll head. the pop is performing in between those two events.
                     */
            ...
            } while (!m_poll.compare_exchange_strong(current, current->previous.load()));
